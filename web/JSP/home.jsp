<%-- 
    Document   : newjsp
    Created on : Oct 17, 2016, 11:14:03 AM
    Author     : lucas
--%>
				...
				<a class="header_logo" href="index.html">
					<span class="header_logo_img">
						<img class = "header_logo_img" src="IMG/Pottermore.png">
                            ...
                            <a class="header_logo" href="PaginaPessoalClone"> <span class="header_toggle header_toggle_profile">Profile</span> </a>
	...
	<div class="main_article">
		<div class="carousel_item-content">
			<div class="carousel_item-content-inner">
				<h1 class="carousel_item-title">Fantastic Beasts: Behind the scenes book covers</h1>
				<a class="carousel_item_button" href="index.html" style="outline:0;">
					<span>Read</span>
				</a>
			</div>	
		</div>
